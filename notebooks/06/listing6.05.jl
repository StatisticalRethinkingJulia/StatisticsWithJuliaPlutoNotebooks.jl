...
begin
	...
	Text("Calculating formula: $((xBar1 - xBar2 - t*sqrt(s1^2/n1 + s2^2/n2),
				  xBar1 - xBar2 + t*sqrt(s1^2/n1 + s2^2/n2)))")
end

# ╔═╡ 60cd0974-3b1d-11eb-0c62-0fe50e45fd7b
Text("Using confint(): $(confint(UnequalVarianceTTest(data1,data2),alpha))")

# ╔═╡ 475ff888-22e6-11eb-2354-09f8f40a8e12
md"## End of listing6.05"
